(() => {
    ...
    function initSliders() {
        if (document.querySelector(".creators-module__slider")) new core(".creators-module__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        if (document.querySelector(".quick-bytes__slider")) new core(".quick-bytes__slider", {
    ...
    async function loadWeather(e) {
        const server = "https://api.openweathermap.org/data/2.5/weather?units=metric&q=Kyiv&appid=17a43f5763c4a1a5cde8b7fea06d63ac";
        const response = await fetch(server, {
            method: "GET"
        });
        const responseResult = await response.json();
    ...
    function getWeather(data) {
        ...
        const template = `\n\t<div class="body-weather-module__info">\n\t\t<h4 class="body-weather-module__status">${location}</h4>\n\t\t<div class="body-weather-module__value">${temp}<sup>0</sup>C</div>\n\t\n\t</div>\n\t<div class="body-weather-module__icon">\n\t\t<img src="http://openweathermap.org/img/w/${weatherIcon}.png" alt="sun"\n\t</div>`;
